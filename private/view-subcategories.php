                        ...
                        <div class="card">
                            <div class="listview lv-bordered lv-lg">
                                <div class="lv-header-alt clearfix">
                                    <h2 class="lvh-label hidden-xs">Available Sub Categories</h2>
                                        ...
                                        <?php  foreach($subcats as $key => $value): ?>
                                            ...
                                            <div class="lv-item media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small class="lv-small"><?php echo $value['description'] ?></small>
                                                    ...
                                                    <div class="lv-actions actions dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            <li><a href="update-subcategory.php?subcatid=<?php echo $value['id'];?>">Edit</a></li>
                                                            <li><a href="delete.php?subcatid=<?php echo $value['id'];?>&action=delete-subcategory">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
