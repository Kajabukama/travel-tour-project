...
<?php
    if (isset($_SESSION['uid'])) {
        ...
        $edit = findById('subcategory',$subcatid);
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if (!empty($category) && !empty($name) && !empty($upload)) {
                ...
                $deleteFile = $uploadDir.$_POST['image'];
                    ...
                    if ($imgSize > 5000) {
                        ...
                        if (file_exists($targetFile)) {
                           ...
                           if(move_uploaded_file($temp, $targetFile)) {
                                ...
                                $query = "UPDATE subcategory SET name = '$name',catid = $category, image = '$filename', description = '$description' WHERE id = $subcatid ";
                                ...
                                <div class="card-body card-padding">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group fg-line">
                                            ...
                                            <input type="text" class="form-control input-sm" id="inputCategory" value="<?php echo $edit['name']; ?>" name="subcategory">
                                        </div>
                                        ...
                                        <p class="f-500 m-b-15 c-black">Select Category</p>
                                            ...
                                            <select class="selectpicker" data-live-search="true" name="category">
                                                <option value="<?php echo $edit['catid']; ?>"><?php echo $edit['name']; ?></option>
                                                <?php 
